...
namespace SIMMAC
{
    ...
    public class PrimaryMemory : ArrayList
    {
        private readonly byte[] _memory;

        public PrimaryMemory(int size)
        {
    ...
    public class IntVariable : INotifyPropertyChanged
    {
        ...
        private readonly PrimaryMemory _memory;

        public IntVariable(int address, PrimaryMemory memory)
        {
            _address = address;
            _memory = memory;
